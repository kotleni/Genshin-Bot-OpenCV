...
def gen_window_bounds(parent: str, title: str = '', options: str = USER_OPTS_STR,
                   relative_to: bool = kCGNullWindowID) -> Iterator[dict]:
    ...
    for num, owner, name, bounds in gen_ids_from_info(windows):
