...
from get_window_id import gen_window_ids, gen_window_bounds, WINDOW_OPTIONS, USER_OPTS_STR

FILE_EXT = '.png'
COMMAND = 'screencapture {options} -x -o -l {window} "{filename}"'
STATUS_OK = 0
STATUS_FAIL = 1
...
def fetch_window_bounds(application_name: str, title: str = '', window_selection_options: str = '') -> Iterator[dict]:
    bounds = gen_window_bounds(application_name, title, window_selection_options)
